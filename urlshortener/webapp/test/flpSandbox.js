		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "URL Shortener",
									"targetURL": "#comurlshortenergrilourlshortener-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comurlshortenergrilourlshortener-display": {
								"semanticObject": "comurlshortenergrilourlshortener",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.urlshortener.grilo.urlshortener",
									"url": sap.ui.require.toUrl("com/urlshortener/grilo/urlshortener")
								}
							}
						}
					}
